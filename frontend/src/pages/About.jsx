    ...
    <div className="min-h-screen bg-kanyo-light-bg dark:bg-kanyo-bg">
      ...
      <header>
        <div className="max-w-5xl mx-auto px-6">
          <div className="py-4 bg-kanyo-light-card dark:bg-kanyo-card rounded-lg border-b border-kanyo-light-gray-300 dark:border-kanyo-gray-500">
            ...
            {/* Title */}
            <div>
              <h1 className="text-3xl font-bold text-kanyo-light-text dark:text-white">The Kanyo Project</h1>
              <p className="text-kanyo-orange italic text-lg">Contemplating Falcons</p>
              <p className="text-kanyo-light-gray-100 dark:text-kanyo-gray-100 text-sm">An open source peregrine falcon monitoring and event archive</p>
            </div>
            </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-kanyo-light-text dark:text-white mb-6">About Kanyo</h1>

        <div className="space-y-6 text-kanyo-light-gray-100 dark:text-kanyo-gray-100">
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">The Origin</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">What It Does</h2>
            <p className="leading-relaxed mb-4">
              Kanyo watches falcon nest cameras 24/7 using computer vision. When a bird arrives or departs, it:
            </p>
            <ul className="list-disc list-inside space-y-2 leading-relaxed">
              <li>Clips the moment automatically</li>
              <li>Sends a Telegram notification</li>
              <li>Archives everything in a searchable timeline</li>
            </ul>
            <p className="leading-relaxed mt-4">
              No more scrubbing through hours of empty nest footage.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">The Vision</h2>
            <p className="leading-relaxed mb-4">
              This is bigger than one nest cam.
            </p>
            <p className="leading-relaxed mb-4">
              The detection engine is open source and designed to be reusable. Anyone monitoring wildlife cameras—researchers tracking breeding patterns, conservation groups watching endangered raptors, citizen scientists documenting behavior—can run Kanyo on their own streams.
            </p>
            <p className="leading-relaxed">
              The viewer you're using now is one possible frontend. The real value is the detection pipeline underneath.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">Get Involved</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-kanyo-light-text dark:text-white mb-2">Ornithologists & Researchers</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-kanyo-light-text dark:text-white mb-2">Developers</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-kanyo-light-text dark:text-white mb-2">Camera Operators</h3>
                <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">Links</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-light-text dark:text-white mb-3">Contact</h2>
            <p className="leading-relaxed">
          ...
          <div className="mt-12 pt-6 border-t border-kanyo-light-gray-300 dark:border-kanyo-gray-500 text-center">
            <p className="text-sm text-kanyo-light-gray-100 dark:text-kanyo-gray-300 italic">
      ...
      <footer className="max-w-5xl mx-auto px-6 pb-8">
        <div className="py-6 bg-kanyo-light-gray-400 dark:bg-kanyo-gray-600 rounded-lg text-center">
