          ...
          <div className="py-4 bg-kanyo-card rounded-lg border-b border-kanyo-gray-500">
            <div className="flex items-center justify-between gap-4 px-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-full bg-kanyo-orange flex items-center justify-center flex-shrink-0">
                  <svg viewBox="0 0 500 548.5" className="w-7 h-7 sm:w-12 sm:h-12 fill-white">
              ...
              <div>
                <h1 className="text-lg sm:text-2xl font-bold text-kanyo-text">The Kanyo Project</h1>
                <p className="text-kanyo-orange italic text-sm">Contemplating Falcons</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <Link to="/" className="text-kanyo-gray-100 hover:text-kanyo-orange transition-colors text-sm font-medium">
                Streams
              </Link>
            </div>
            </div>
