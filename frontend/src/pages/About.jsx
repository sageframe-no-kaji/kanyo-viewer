    ...
    <div className="min-h-screen bg-kanyo-bg">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="space-y-6 text-kanyo-gray-100">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">What It Does</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">The Vision</h2>
            <p className="leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">Get Involved</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Ornithologists & Researchers</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Developers</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Camera Operators</h3>
                <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">Contact</h2>
            <p className="leading-relaxed">
          ...
          <div className="mt-12 pt-6 border-t border-kanyo-gray-500 text-center">
            <p className="text-sm text-kanyo-gray-100 italic">
