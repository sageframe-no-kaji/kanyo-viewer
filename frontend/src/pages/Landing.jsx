      ...
      <header className="border-b border-kanyo-gray-500 bg-kanyo-card">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            {/* Logo Circle */}
            <div className="w-16 h-16 rounded-full bg-kanyo-gray-600 flex items-center justify-center flex-shrink-0">
              <svg viewBox="0 0 500 548.5" className="w-12 h-12" style={{filter: 'invert(60%) sepia(80%) saturate(600%) hue-rotate(350deg)'}}>
