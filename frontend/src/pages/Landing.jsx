          ...
          <div className="py-4 bg-kanyo-card rounded-lg border-b border-kanyo-gray-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4">
              ...
              <div className="flex items-center gap-3">
                {/* Logo Circle */}
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-kanyo-orange flex items-center justify-center flex-shrink-0">
                  <svg viewBox="0 0 500 548.5" className="w-7 h-7 sm:w-9 sm:h-9 fill-white">
              ...
              <div className="min-w-0">
                <h1 className="text-base sm:text-xl lg:text-2xl font-bold text-kanyo-text leading-tight">The Kanyo Project</h1>
                <p className="text-kanyo-orange italic text-xs sm:text-sm">Contemplating Falcons</p>
                <p className="text-kanyo-gray-100 text-[10px] sm:text-xs hidden sm:block">An open source peregrine falcon monitoring and event archive</p>
              </div>
            </div>

            {/* Controls - right side on desktop, below on mobile */}
            <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-4">
              <p className="text-kanyo-gray-100 text-[10px] sm:hidden">Open source falcon monitoring</p>
              <div className="flex items-center gap-3">
                <ThemeToggle />
                <Link to="/about" className="text-kanyo-gray-100 hover:text-kanyo-orange transition-colors text-sm font-medium">
                  About
                </Link>
              </div>
            </div>
    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-start justify-between mb-2">
          <h2 className="text-xl font-semibold text-kanyo-text">{display.short_name || stream.name}</h2>
        ...
        <div className="text-sm text-kanyo-gray-100 space-y-1">
          <div className="flex justify-between">
            ...
            <span className="text-kanyo-text font-medium">{stats.visits || 0}</span>
          </div>
          <div className="flex justify-between">
