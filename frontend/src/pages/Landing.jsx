        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="py-4 bg-kanyo-card rounded-lg border-b border-kanyo-gray-500">
            <div className="flex items-start justify-between gap-4">
              ...
              {/* Logo Circle - smaller for mobile */}
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-kanyo-orange flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 500 548.5" className="w-9 h-9 sm:w-12 sm:h-12 fill-white">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold text-kanyo-text whitespace-nowrap">The Kanyo Project</h1>
              <p className="text-kanyo-orange italic text-sm sm:text-base lg:text-lg">Contemplating Falcons</p>
              <p className="text-kanyo-gray-100 text-xs sm:text-sm">An open source peregrine falcon monitoring and event archive</p>
            </div>
            </div>
