  ...
  return (
    <div className="min-h-screen bg-kanyo-bg">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <h1 className="text-4xl font-bold text-kanyo-text mb-6">Getting Alerts</h1>

        <div className="space-y-6 text-kanyo-gray-100">

          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">What is Telegram?</h2>
            <p className="leading-relaxed mb-4">
              Telegram is a free messaging app—like WhatsApp or iMessage—that works on phones, tablets, and computers. Kanyo uses Telegram to send you instant notifications when a falcon arrives or departs.
            </p>
            <p className="leading-relaxed mb-4">
              You don't need to create an account with us or give us your phone number. You simply "join" a public channel and Telegram delivers the alerts to you.
            </p>
            <p className="leading-relaxed">
              Telegram is free, has no ads, and is available worldwide.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">What You'll Receive</h2>
            <p className="leading-relaxed mb-4">
              When a falcon arrives or departs, you'll get a notification with:
            </p>
            <ul className="list-disc list-inside space-y-2 leading-relaxed mb-4">
              <li>The event type (arrival or departure)</li>
              <li>The time it happened (in the stream's local timezone)</li>
              <li>A video clip of the moment</li>
            </ul>
            <p className="leading-relaxed">
              Alerts typically arrive within seconds of the event.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">How to Subscribe</h2>

            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">1. Install Telegram</h3>
                <p className="leading-relaxed">
                  Download the free app for your device:
                </p>
                <ul className="list-disc list-inside space-y-1 leading-relaxed mt-2">
                  <li><a href="https://apps.apple.com/app/telegram-messenger/id686449807" target="_blank" rel="noopener noreferrer" className="text-kanyo-orange hover:text-white transition-colors">iPhone / iPad (App Store)</a></li>
                  <li><a href="https://play.google.com/store/apps/details?id=org.telegram.messenger" target="_blank" rel="noopener noreferrer" className="text-kanyo-orange hover:text-white transition-colors">Android (Google Play)</a></li>
                  <li><a href="https://telegram.org/apps" target="_blank" rel="noopener noreferrer" className="text-kanyo-orange hover:text-white transition-colors">Desktop & Web</a></li>
                </ul>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">2. Open a Channel</h3>
                <p className="leading-relaxed">
                  Click the blue "Subscribe" button on any stream page. This will open the channel in Telegram. If you're on a computer, you may need to have Telegram desktop installed or use Telegram Web.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">3. Join the Channel</h3>
                <p className="leading-relaxed">
                  Tap "Join" at the bottom of the channel. That's it—you'll now receive alerts whenever there's falcon activity on that stream.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">Tips</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Mute Notifications</h3>
                <p className="leading-relaxed">
                  Getting too many alerts? You can mute a channel while still receiving messages. Long-press (or right-click) the channel → Notifications → Mute. Messages will still appear, but your phone won't buzz.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Multiple Streams</h3>
                <p className="leading-relaxed">
                  Each stream has its own Telegram channel. Subscribe to as many as you like—they're all independent.
                </p>
              </div>

              <div>
                <h3 className="text-lg font-semibold text-kanyo-text mb-2">Leaving a Channel</h3>
                <p className="leading-relaxed">
                  To stop receiving alerts, open the channel in Telegram, tap the channel name at the top, and select "Leave Channel."
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-kanyo-text mb-3">Why Telegram?</h2>
            <p className="leading-relaxed mb-4">
              We chose Telegram because:
            </p>
            <ul className="list-disc list-inside space-y-2 leading-relaxed">
              <li>It's free for everyone, including us</li>
              <li>No account registration required on our end</li>
              <li>Supports video clips directly in notifications</li>
              <li>Works reliably worldwide</li>
              <li>You control your notifications—mute, leave, or customize as needed</li>
            </ul>
          </section>

          <div className="mt-12 pt-6 border-t border-kanyo-gray-500">
      ...
      <footer className="max-w-5xl mx-auto px-6 pb-8">
        <div className="py-6 bg-kanyo-card rounded-lg text-center">
