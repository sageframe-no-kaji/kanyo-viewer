        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-kanyo-card border-b border-kanyo-gray-500 rounded-t-lg lg:rounded-none overflow-hidden">
            ...
            <div className="lg:hidden">
              {/* Title row */}
              <div className="flex items-center justify-center gap-3 py-4 px-6 border-b border-kanyo-gray-500">
                <svg viewBox="0 0 360.6 198.2" className="h-8 fill-kanyo-orange">
