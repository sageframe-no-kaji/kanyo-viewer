      ...
      <div className="bg-kanyo-card rounded-lg overflow-hidden">
        <div className="relative" style={{ paddingBottom: '56.25%' }}>
          <iframe
            ...
            src={`https://www.youtube.com/embed/${stream.youtube_id}?autoplay=1&mute=0&controls=1&rel=0`}
            title="Live Stream"
            frameBorder="0"
  ...
  return (
    <div className="bg-kanyo-card rounded-lg overflow-hidden">
      <div className="aspect-video bg-kanyo-gray-600 flex flex-col items-center justify-center">
        <svg viewBox="0 0 500 548.5" className="w-2/5 opacity-40" style={{filter: 'invert(60%) sepia(80%) saturate(600%) hue-rotate(350deg)'}}>
      ...
      <div className="px-4 pt-3 pb-2 border-t border-kanyo-gray-500">
        <div className="flex items-center justify-between">
          ...
          <p className="text-kanyo-gray-100 text-sm">or click LIVE</p>
        </div>
      </div>
    </div>
  );
