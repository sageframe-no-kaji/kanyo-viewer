...
export default function CameraInfo({ stream, visitorTimezone, onTimezoneChange, className = '' }) {
  ...
  return (
    <div className={`bg-kanyo-card rounded-lg p-4 h-full lg:h-auto flex flex-col ${className}`}>
      ...
      {display.description && (
        <div>
          ...
          <div
            ref={descriptionRef}
            className="text-kanyo-text text-xs leading-relaxed max-h-[8lh] overflow-y-auto"
          >
            {display.description}
          </div>
        </div>
